...
task CollectHsMetrics {
  ...
  Int rounded_bam_size = ceil(size(input_bam, "GiB") + 0.5 + 10)
  Int rounded_memory_size = ceil((if (rounded_bam_size > 25) then 25 else rounded_bam_size) * memory_multiplier)
